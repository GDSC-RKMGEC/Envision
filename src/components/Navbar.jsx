    ...
    <>
      <div className="absolute w-full h-24 bg-black text-white z-20">
        <div className="flex justify-between items-center max-w-screen-xl mx-auto px-4 h-full">
          <div>
            <h1 className="text-thBlue tracking-widest text-3xl">ENVISION</h1>
          </div>
          ...
          <div className="hidden lg:flex items-center">
            ...
            <GradientBtn className="ml-4 capitalize" title="Coming Soon" />
          </div>
      ...
      >
        <ul>
          ...
          <GradientBtn className="mt-10 capitalize" title="Coming Soon" />
        </ul>
      </div>
    </>
  );
